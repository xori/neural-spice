...
\begin{abstract}
  ...
  the structure and weights of the network to attempt to encourage learning.
\end{abstract}
...
\section{Analysis}
	\subsection{Connect 4}
		\subsubsection*{Run 1) Union/Intersect}
			...
			we can see that the Connect 4 problem is computationally hard to learn. 
		\subsubsection*{Run 2) Vanilla Backprop}
			\begin{figure}[here]%[!t]
			  \centering
